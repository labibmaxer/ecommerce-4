...
const products = [
  {
    ...
    price: 49.99,
    img: "https://via.placeholder.com/400x400?text=Headphones",
    rating: 4.3,
    reviewCount: 2148,
  ...
  },
  {
    ...
    price: 89.99,
    img: "https://via.placeholder.com/400x400?text=Keyboard",
    rating: 4.6,
    reviewCount: 973,
  ...
  },
  {
    ...
    price: 24.99,
    img: "https://via.placeholder.com/400x400?text=Mouse",
    rating: 4.1,
    reviewCount: 512,
  ...
  },
  {
    ...
    price: 299.99,
    img: "https://via.placeholder.com/400x400?text=Monitor",
    rating: 4.7,
    reviewCount: 1389,
  ...
  },
  {
    ...
    price: 19.99,
    img: "https://via.placeholder.com/400x400?text=USB+Hub",
    rating: 4.0,
    reviewCount: 764,
...
const categoryItems = [
  { id: 101, title: "Jeans under $50", price: 39.99, img: "https://via.placeholder.com/300x300?text=Jeans", rating: 4.2, reviewCount: 340, description: "Classic-fit denim jeans made from durable stretch cotton, built to last through every season.", bullets: ["Stretch denim for all-day comfort", "Reinforced stitching at stress points", "Machine washable", "Available in multiple washes"] },
  { id: 102, title: "Tops under $25", price: 18.5, img: "https://via.placeholder.com/300x300?text=Tops", rating: 4.0, reviewCount: 210, description: "Soft, breathable everyday tops in a range of colors, perfect for layering or wearing on their own.", bullets: ["Lightweight breathable fabric", "Pre-shrunk cotton blend", "Machine washable", "Available in 6 colors"] },
  { id: 103, title: "Dresses", price: 34.99, img: "https://via.placeholder.com/300x300?text=Dresses", rating: 4.4, reviewCount: 502, description: "Flattering everyday dresses designed for comfort without sacrificing style.", bullets: ["Flowy, breathable fabric", "Adjustable waist tie", "Machine washable", "True to size fit"] },
  { id: 104, title: "Shoes", price: 44.99, img: "https://via.placeholder.com/300x300?text=Shoes", rating: 4.3, reviewCount: 890, description: "Comfortable everyday sneakers with cushioned soles, built for walking and light exercise.", bullets: ["Cushioned memory-foam insole", "Breathable mesh upper", "Non-slip rubber outsole", "Lightweight design"] },
  { id: 105, title: "Kitchen & Dining", price: 27.99, img: "https://via.placeholder.com/300x300?text=Kitchen", rating: 4.5, reviewCount: 623, description: "Essential kitchen and dining accessories to upgrade your everyday cooking and mealtime setup.", bullets: ["Dishwasher-safe materials", "Space-saving design", "Durable, food-safe construction", "Easy to clean"] },
  { id: 106, title: "Home Decor", price: 22.0, img: "https://via.placeholder.com/300x300?text=Decor", rating: 4.2, reviewCount: 275, description: "Stylish decor pieces to refresh any room, from minimalist accents to statement pieces.", bullets: ["Lightweight, easy to hang or place", "Neutral tones fit most interiors", "Durable materials", "Simple assembly"] },
  { id: 107, title: "Bedding & Bath", price: 54.99, img: "https://via.placeholder.com/300x300?text=Bedding", rating: 4.4, reviewCount: 812, description: "Soft, breathable bedding and bath essentials for a comfortable, cozy home.", bullets: ["Brushed microfiber fabric", "Fade-resistant colors", "Machine washable", "Fits standard mattress sizes"] },
  { id: 108, title: "Lighting", price: 29.99, img: "https://via.placeholder.com/300x300?text=Lighting", rating: 4.1, reviewCount: 198, description: "Modern lighting fixtures that bring warmth and ambiance to any space.", bullets: ["Energy-efficient LED compatible", "Dimmable brightness control", "Easy tool-free installation", "Modern minimalist design"] },
  { id: 109, title: "Cookers & Appliances", price: 129.99, img: "https://via.placeholder.com/500x400?text=Cookers", rating: 4.6, reviewCount: 1042, description: "Reliable kitchen appliances built to make everyday cooking faster and easier.", bullets: ["Multiple cooking presets", "Easy-clean non-stick interior", "Compact countertop footprint", "1-year limited warranty"] },
  { id: 110, title: "Backpacks", price: 32.99, img: "https://via.placeholder.com/300x300?text=Backpacks", rating: 4.5, reviewCount: 654, description: "Durable, spacious backpacks built for school, work, or travel.", bullets: ["Padded laptop compartment", "Water-resistant fabric", "Ergonomic padded straps", "Multiple organizer pockets"] },
  { id: 111, title: "Electronics", price: 15.99, img: "https://via.placeholder.com/300x300?text=Electronics", rating: 4.0, reviewCount: 320, description: "Handy electronics accessories to keep you charged and connected on the go.", bullets: ["Compact and portable", "Compatible with most devices", "Durable braided cables", "1-year warranty"] },
  { id: 112, title: "Notebooks", price: 8.99, img: "https://via.placeholder.com/300x300?text=Notebooks", rating: 4.3, reviewCount: 410, description: "High-quality notebooks with smooth, bleed-resistant paper for writing or sketching.", bullets: ["120 lined pages", "Durable hardcover", "Elastic closure band", "Ribbon bookmark"] },
  { id: 113, title: "Stationery", price: 6.5, img: "https://via.placeholder.com/300x300?text=Stationery", rating: 4.1, reviewCount: 187, description: "A well-rounded stationery set covering all your everyday writing needs.", bullets: ["Includes pens, pencils, and erasers", "Smooth, smudge-resistant ink", "Compact carrying case", "Great for school or office"] }
];
